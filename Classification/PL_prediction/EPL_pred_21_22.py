...
df = pd.read_excel('final_dataset2022.xlsx')
...
previsao_rodada31 = previsao_final[[(    'TimeCasa',),(    'TimeFora',),
                                    ( 'GC_previsão',),( 'GF_previsão',),
                                    ]]
cond = [previsao_rodada31[('GC_previsão',)]>previsao_rodada31[('GF_previsão',)],
          previsao_rodada31[('GC_previsão',)]<previsao_rodada31[('GF_previsão',)],
          previsao_rodada31[('GC_previsão',)]==previsao_rodada31[('GF_previsão',)]
          ]
choice = ['V','D','E']

previsao_rodada31['RF'] = np.select(cond,choice,'ERRO')
previsao_rodada31.to_excel('previsão_rodada_31.xlsx', index = False)
